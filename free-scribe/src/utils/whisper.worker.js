...
async function transcribe(audio) {
    ...
    if (!pipelineInstance || !pipelineInstance.model || !pipelineInstance.processor) {
        console.error('Pipeline instance is not correctly initialized.');
        sendLoadingMessage('error');
        return;
    }
...
class GenerationTracker {
    constructor(pipeline, stride_length_s) {
        if (!pipeline || !pipeline.processor || !pipeline.model) {
            throw new Error('Pipeline is not correctly initialized.');
        }
