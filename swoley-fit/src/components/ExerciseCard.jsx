...
export default function ExerciseCard(props) {
  ...
  return (
    <div className='p-4 rounded-md flex flex-col bg-slate-950 sm:flex-wrap'>
      ...
      <div className='flex flex-col bg-slate-950 rounded gap-2 py-3 '>
        {exercise.description.split('__').map((desc) => {
          return (
      ...
      <div className='grid grid-cols sm:grid-col-4 sm:place-items-center gap-2'>
        {['reps', 'rest', 'tempo'].map(info => {
          return (
            <div key={info} className='flex flex-col p-2 rounded border-[1.5px] border-slate-900 w-full'>
        ...
        <button onClick={handleSetIncrement} className='flex flex-col p-2 rounded border-[1.5px] duration-200 border-slate border-blue-900 hover:border-blue-600 w-full duration-200'>
